...
def generate_cycle_2cw_dataset(num_samples, output_file):
    # 26 lowercase + 6 uppercase = 32 tokens
...
generate_cycle_2cw_dataset(20000, '../data/cycle_32t_2cw-train.txt')
generate_cycle_2cw_dataset(4000, '../data/cycle_32t_2cw-val.txt')
